...
import SocialMediaContainer from "../components/socialMediaFeed/SocialMediaContainer";
export default [
  {
    post: {
      ...
      followups: [
        {
          ...
          answers: [
            <text>
              Studies show that we take note of one thing: we immediately try to
              figure out if someone is a threat to us, and we analyze their
              facial features to distinguish friend from foe.
            </text>,
          ],
        },
        {
...

  {
    post: {
      ...
      subheader:
        "What exepctations and preconceptions do we hold for different groups of people?",
      ...
      followups: [
        {
          ...
          answers: [
            <text>
              <b>In some cases, personalizing ads is beneficial.</b> For
              example, sports teams fans would probably want to buy merch for
              the teams that they are interested in as opposed to any random
              team, so personalization can help to give ads relevant to the
              user.
            </text>,
            <text>
              <b>In other cases, personalizing ads will promote unfairness.</b>{" "}
              For example, if the optimized algorithm observes that men are more
              likely to respond to software engineer roles, a femaile software
              engineer would be much less likely to encounter advertisements
        ...
        },
        {
          ...
          answers: [
            <text>
              According to law, <b>discrimination</b> is defined as the
              treatment, consideration, or distinction in favor of or against a
              person based on the group or class that they belong to rather than
              on individual merit.
            </text>,
            <text>
              <b>Legally protected classes</b> include race, color, sex,
              religion, national origin, citizenship, age, pregnancy, familial
              status, disability status, veteran status, and genetic
              information.
            </text>,
            <text>
              <b>
      ...
      followups: [
        {
          ...
          answers: [
            <text>
              The data that the algorithm was trained on may be a{" "}
              <b>skewed sample</b> that reflects our society's biases. Training
              on such data will cause a <b>feedback loop</b>, which compounds
              the initial bias over time.
            </text>,
            <text>
              <b>Here's how it works:</b> The algorithm observes from the data
              that people of color (POC) tend to buy cheaper homes on average
              than non-POC. It then advertises cheaper listings to POC and more
              expensive listings to non-POC in order to maximize ad views.
      ...
      followups: [
        {
          ...
          answers: [
            <a href="https://www.technologyreview.com/2019/04/05/1175/facebook-algorithm-discriminates-ai-bias/">
              MIT Technology Review article - Facebook's ad-serving algorithm
              discriminates by gender and race
            </a>,
            <a href="https://arxiv.org/pdf/1904.02095.pdf">
